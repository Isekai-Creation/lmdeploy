    ...
    def __init__(
        ...
        **kwargs,
        ...
        if _engine_config.speculative_config is not None:
            from lmdeploy.turbomind.speculative_manager import (
                SpeculativeDecodingManager,
            )

            try:
                self.speculative_manager = SpeculativeDecodingManager(
                    _engine_config.speculative_config, self.model_comm
                )
                logger.info(
